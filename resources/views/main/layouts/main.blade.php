...
<head>
    ...
    <link rel="stylesheet" href="{{asset('main/css/main-bravo-01-02-23.css')}}">
    <link rel="stylesheet" href="{{asset('main/css/main-bravo-19-04-2023.css')}}">
    ...
    <link rel="stylesheet" href="{{asset('main/css/main-charlie-19-04-2023.css')}}">
    ...
    <link rel="stylesheet" href="{{asset('main/css/main-charlie-11-01-2023.css')}}">
    <link rel="stylesheet" href="{{asset('main/css/main-delta-12-01-2023.css')}}">
    <link rel="stylesheet" href="{{asset('main/css/main-delta-13-01-23.css')}}">
    <link rel="stylesheet" href="{{asset('main/css/main-delta-10-02-2023.css')}}">
    @stack('styles')
</head>
<body data-pusher-key="{{config('broadcasting.connections.pusher.key')}}" data-user-id="@if(auth()->check()){{auth()->user()->id}}@endif">
...
<script src="{{asset('main/js/air-datepicker.js')}}"></script>
{{--<script src="{{asset('main/js/choices.js')}}"></script>--}}
...
<script src="{{asset('main/js/main-bravo-01-02-23.js')}}"></script>
<script src="{{asset('main/js/main-charlie.js')}}"></script>
<script src="{{asset('main/js/main-charlie-28-12-22.js')}}"></script>
<script src="{{asset('main/js/main-charlie-19-04-23.js')}}"></script>
<script src="{{asset('main/js/main-delta.js')}}"></script>
<script src="{{asset('main/js/main-delta-28-12-22.js')}}"></script>
<script src="{{asset('main/js/main-delta-13-01-23.js')}}"></script>
<script src="{{asset('main/js/product-like.js')}}"></script>
<script src="https://js.pusher.com/7.0/pusher.min.js"></script>
<script src="{{asset('main/js/message-count-socket.js')}}"></script>
<script src="{{asset('main/js/notification-socket.js')}}"></script>
@stack('scripts')
</body>
</html>
