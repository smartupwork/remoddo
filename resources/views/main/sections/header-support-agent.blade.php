    ...
    <div class="header--item bg--white py-12">
        <div class="flex-auto d-flex align-items-center">
            ...
            <div class="header--option flex-500 mx-20 hidden-480">
                <form class="input-search-form w-100" action="">
                    <label class="relative">
                        <input type="text" data-url="" name="search"
                               value="" class="product-search input-search-window w-100"
            ...
            @if(!$is_admin)
                <div class="header--option hidden-768">
                    <a href="{{route('support.supportAgentStatus')}}"
