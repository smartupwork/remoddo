<div id="wardrobe-delete" class="modal return-label send-back ">
    <div class="modal__dialog modal__dialog--600">
        <div class="modal__content">
            <div class="modal__header flex-column pb-0">
                <h2 class="modal__title mb-2">Deleting product</h2>
            ...
            <div class="modal__body align-items-center">
                ...
                <div class="d-flex align-items-center">
                    <a href="" class="btn delete-cancel btn--dark btn--md radius-3 min-w-150 ttu me-3 mb-10">
                        <span class="fs-14">No</span>
                    </a>
                    <a href="" class="btn delete-submit btn--warning btn--md radius-3 min-w-150 mb-10 ttu">
